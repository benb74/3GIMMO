...
@section('content')
    ...
    <form method="post" action="{{route('update_property')}}" style="padding: 5em">
        ...
        Surface habitable : <input type="text" name="surface_habitable" value="{{$property->surface_habitable}}"> metres carres<br><br>
        Nombre de pieces : <input type="text" name="nombre_de_piece" value="{{$property->nombre_de_piece}}"> pieces<br><br>
        Code vendeur* : <input type="text" name="id_seller" value="{{$property->id_seller}}" required="required"> (nombre uniquement)<br><br>
